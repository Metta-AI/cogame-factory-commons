...
# Substitute: factory-commons, coworld-factory-commons, 3.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-factory-commons:ci)
#   SMOKE_SLUG                 game slug                        (factory-commons)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/factory-commons)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/factory-commons-player)
#   SMOKE_MANIFEST             manifest template path           (coworld_manifest_template.json)
#   SMOKE_SEATS                seat-count CROSS-CHECK           (3)
...
image="${1:-${SMOKE_IMAGE:-coworld-factory-commons:ci}}"
slug="${SMOKE_SLUG:-factory-commons}"
