...
# use-after-free fixed in factory_commons_replay.nim (emscripten_exit_with_live_runtime)
...
# factory_commons_stage_ptr/len afterwards to report what the runtime was doing.
switch(
  "passL",
  (&"""
  -o {distDir / "factory_commons_replay.js"}
  ...
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_factory_commons_load_replay,_factory_commons_frame,_factory_commons_input,_factory_commons_packet_ptr,_factory_commons_packet_len,_factory_commons_error_ptr,_factory_commons_error_len,_factory_commons_stage_ptr,_factory_commons_stage_len
  """).replace("\n", " ")
)
